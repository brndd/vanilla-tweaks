...
struct Args {
    ...
    // If set, do not patch the mouse camera jump.
    #[clap(long, default_value_t = false, value_parser)]
    no_mousecamerajump: bool
}
...
fn main() -> ExitCode {
    ...
    // Mouse camera jump patch
    if !args.no_mousecamerajump {
        let patches: [(usize, Vec<u8>); 5] = [
            (0x02ccd0, vec![0x55,
                            0x8b, 0x05, 0x48, 0x4e, 0x88, 0x00,
                            0x8b, 0x0d, 0x44, 0x4e, 0x88, 0x00,
                            0xe9, 0x33, 0x90, 0x32, 0x00,
                            0x83, 0xc0, 0x32,
                            0x83, 0xc1, 0x32,
                            0x3b, 0x0d, 0xa8,
                            0xeb, 0xc4, 0x00,
                            0x7e, 0x03,
                            0x83, 0xe9, 0x01,
                            0x3b, 0x05, 0xac, 0xeb, 0xc4, 0x00,
                            0x7e, 0x03,
                            0x83, 0xe8, 0x01,
                            0x83, 0xe9, 0x32,
                            0x83, 0xe8, 0x32,
                            0x89, 0x05, 0x48, 0x4e, 0x88, 0x00,
                            0x89, 0x0d, 0x44, 0x4e, 0x88, 0x00,
                            0x5d,
                            0xeb, 0x0d]),
            (0x02d326, vec![0xe9, 0xb1, 0x8a, 0x32, 0x00]),
            (0x02d334, vec![0x8b, 0x35, 0x48, 0x4e, 0x88, 0x00]),
            (0x355d15, vec![0x83, 0xf8, 0x32,
                            0x7d, 0x03,
                            0x83, 0xc0, 0x01,
                            0x83, 0xf9, 0x32,
                            0x7d, 0x03,
                            ...
                            0xe9, 0xb8, 0x6f,
                            0xcd, 0xff]),
            (0x355ddc, vec![0x8d, 0x4d, 0xf0,
                            0x51,
                            0xff, 0x35, 0x00, 0x4e, 0x88, 0x00,
                            0xff, 0x15, 0x50, 0xf6, 0x7f, 0x00,
                            0x8b, 0x45, 0xf0,
                            0x8b, 0x15, 0x44, 0x4e, 0x88, 0x00,
                            0xe9, 0x35, 0x75, 0xcd, 0xff])
        ];

        print!("Applying patch: mouse camera jump fix...");
