...
There are command-line options available to customize the values of and disable some of the tweaks. Run the program with the `--help` parameter to get a list of them.
